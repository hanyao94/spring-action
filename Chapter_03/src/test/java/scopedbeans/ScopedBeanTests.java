...
import com.seven.spring.action.scopedbeans.Notepad;
import com.seven.spring.action.scopedbeans.UniqueThing;
...
public class ScopedBeanTests {
  ...
  @RunWith(SpringJUnit4ClassRunner.class)
  @ContextConfiguration("classpath:META-INF/scopedbeans/scoped-beans.xml")
